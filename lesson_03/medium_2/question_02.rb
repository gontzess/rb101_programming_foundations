...
=begin
Steve assessment/wording:
- Variable reassignment within a method invocation with a block can impact the variables after invocation, so long as the variables are defined prior & outside.
- Variable reassignment within a method call (instead of a block) will not impact the variables outside, even if they were previously defined outside. The method gets the VALUES of the arguments we pass.
=end
