...
#     - returns a list of all palindromes possible
#     - a palindrome is a word that reads the same forwards and backward)
#     - case sensitive so Mom is not a pal but mom is
#   implicit requirements:
#     - an empty string returns an empty array
#     - a string with no palindromes returns an empty array
#     - the substrings in the return array are alphabetically ordered?
#     - the method should return a different object since its returning an array
